...
<body>
	<div id="wrap">
		...
		<div id="container">
			<div id="content">
				<form action="<c:url value='/qna/qna-add.do'/>" method="post"
					...
					<table>
						...
						<tr>
							...
							<td><input multiple="multiple" type="file"
								name="qnaAttachment"></td>
						</tr>
					</table>

					<input type="submit" value="등록"> <input type="reset"
						value="입력한 내용 지우기"> <a
						href="<c:url value='/qna/qna-list.do'/>">문의게시판으로 이동</a> <input
						type="hidden" name="userNo" value="${ user.userNo }"> <input
